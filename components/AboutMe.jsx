    ...
    >
      <div className="relative w-full   pb-28 md:pb-0  items-center md:flex md:justify-center">
        ...
        <Image
          ...
          className="w-72 -rotate-6 absolute -left-28 -top-40  z-10 md:static"
        />{" "}
        <h2 className="text-5xl font-serif pr-4 py-2 tracking-wide text-right  w-full bg-gray-100 text-brand-dark-green md:w-fit  md:rounded-3xl md:px-14 md:-ml-16 ">
          About Me
        </h2>
      </div>
      <div className="bg-brand-light-green font-medium text-zinc-900 text-xl tracking-wide text-left rounded-3xl py-10 px-10 shadow-[0px_4px_0px_0px_#1f2b2d] md:-mt-8 w-full ">
        <p className=" flex flex-col gap-5 md:max-w-4xl md:mx-auto">
