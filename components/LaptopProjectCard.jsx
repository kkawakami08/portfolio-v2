...
const LaptopProjectCard = ({ project }) => {
  return (
    <Link href={project.url} className="group">
      <div className="grid grid-cols-2 gap-5 relative overflow-hidden p-5 pb-3 rounded-3xl bg-[#ffc44a]  shadow-[0px_4px_0px_0px_#dd6302] min-h-64 max-w-md transition ease-in-out   group-hover:-translate-y-1 group-hover:scale-105  duration-300">
        <Image
          src={project.image}
          width="0"
          height="0"
